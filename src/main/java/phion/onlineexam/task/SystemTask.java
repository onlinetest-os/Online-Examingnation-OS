...
public class SystemTask {
	 ...
	 * 1、	将所有开始时间为当天的考试状态修改为ready_today
		2、	执行更新开启考试的操作。
	 */
	//@Scheduled(StaticResources.TEST_SYSTEM_DAILY_TASK_CRON) // 间隔5秒执行
	@Scheduled(cron=StaticResources.SYSTEM_DAILY_TASK_CRON) //每天晚上0点执行一次
